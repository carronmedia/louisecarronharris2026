...
This repository **is the WordPress webroot**. WordPress core, plugins, and uploads are installed at runtime and **not committed** — see [`.gitignore`](.gitignore) for the full exclusion list. Project code lives in the [`louise-carron-harris` theme](wp-content/themes/louise-carron-harris/).
...
| Theme | Standalone FSE block theme — [`wp-content/themes/louise-carron-harris/`](wp-content/themes/louise-carron-harris/) |
